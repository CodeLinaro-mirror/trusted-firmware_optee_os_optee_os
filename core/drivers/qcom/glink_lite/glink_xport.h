 ...
 */
typedef enum glink_err_type (*tx_cmd_ch_open_fn)(
	struct glink_transport_if *if_ptr
);
typedef enum glink_err_type (*tx_cmd_ch_close_fn)(
	struct glink_transport_if *if_ptr
);
typedef enum glink_err_type (*tx_cmd_local_rx_done_fn)(
	struct glink_transport_if *if_ptr, const void *ptr
);
